...
from .geometry import calculateAngles
...
def angles(c1, c2, p1, p2, n1, n2):
    return calculateAngles(c1, c2, p1, p2, n1, n2)


def main():
    inputpath = Path(__file__).with_name("coordR25d10.txt")
    with inputpath.open("r", encoding="utf-8") as my_input:
